...
const App = () => {
  const students = [
    ...
    {name:"Nansi Goyal" , email:"goyalnansi027@gmail.com" , phone: 2345633731},
    {name:"Palak Goyal" , email:"palak027@gmail.com" , phone: 7409633731},
    {name:"Manvi Mehra" , email:"mehramanvi0125@gmail.com" , phone: 7409633731},
...
<ol className="order">
    ...
    <div className="App">
      ...
      <input type="checkbox"className="form-check-box"/> 
       <h2>the data of student is :{data.name}, {data.email}, {data.phone}</h2>
    ...
    <div className="card-body app3"> 
    <h1>React Web</h1>
    <div className="app1">
    <h2 className="app1">{count}</h2>
    <button className="app1" onClick={()=> setCount(count+1)}>Increment</button>
    <button className="app1" onClick={()=> setCount(count-1)}>Decrement</button>
    <button className="app1" onClick={()=> setCount(0)}>Reset</button>
